...
/**
 * Class which contains a boundary and methods to check if something if is
 * inside the borders
 *
 * @author Gruppe A
 */
public class Boundary {
    ...
    /**
     * Constructor which sets up the boundary values depending on the given
    ...
    /**
     * Overloaded constructor which creates the first boundary object when a
     * quadtree is initiated.
     *
     * @param direction
     */
    ...
    /**
     * Checks whether the given two points form a rectangle that intersects with
     * the boundary area.
     *
     * @param x1
     * @param y1
